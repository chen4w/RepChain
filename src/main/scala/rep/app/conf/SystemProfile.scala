...
object SystemProfile {
  ...
  private[this] var _UDPSERVERPORT:Int=65536 //udp服务的端口
  ...
  private def UDPSERVERPORT: Int = _UDPSERVERPORT
  ...
  private def UDPSERVERPORT_=(value: Int): Unit = {
  ...
  def initConfigSystem(config:Config): Unit ={
    ...
    UDPSERVERPORT_=(config.getInt("system.udpServicePort"))
  ...
  def getUdpServicePort = UDPSERVERPORT
